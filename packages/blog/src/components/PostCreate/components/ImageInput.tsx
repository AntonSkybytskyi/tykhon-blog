...
const ImageInput: Component<{ thumbnail?: string | null, name: string }> = (props) => {
    const [currentImage, setCurrentImage] = createSignal<string | null>(props.thumbnail ?? null);
    ...
    return <>
        <label for="thumbnail" class="block text-gray-700 font-bold mb-2">Cover Image</label>

        <div class="flex items-center justify-center w-full">
            <input id="dropzone-file" name={props.name} type="file" class="hidden" onChange={onCoverImageChange} />
            {!!currentImage() && (
